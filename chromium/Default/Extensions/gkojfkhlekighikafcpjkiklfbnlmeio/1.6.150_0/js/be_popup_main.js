...
define(['be_config', 'jquery', 'underscore', 'be_backbone', 'etask',
    'be_browser', 'zerr', 'be_ui_obj', 'be_popup_lib', 'purl', 'be_util',
    'be_locale', 'version_util', 'be_user_nav'],
    function(be_config, $, _, be_backbone, etask, B, zerr, be_ui_obj,
    be_popup_lib, purl, be_util, T, version_util, be_user_nav){
