...
define(['jquery', 'underscore', 'etask', 'be_backbone', 'zerr', 'string',
    'version_util', 'user_agent'], function($, _, etask, be_backbone, zerr,
    string, version_util, user_agent){
