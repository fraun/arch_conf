...
define(['jquery', 'etask', 'zerr', 'be_msg', 'be_backbone', 'be_chrome',
    'underscore', 'string', 'version_util', 'be_transport', 'user_agent',
    'util'],
...
function firefox_have(){
    ...
    if (vcmp('1.4.756')>=0) // XXX bahaa: enable
        have.req_headers_listeners = !!conf.ff_webrequest2;
    if (vcmp('1.3.427')>=0)
